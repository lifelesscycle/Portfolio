...
/* Same engine as the reference LightPillar demo — `interactive` already
   defaulted to false there, so it's left as-is: no pointer listener is
   ever attached unless a call site opts in explicitly. */
const LightPillar = ({
  topColor = '#5227FF',
  bottomColor = '#FF9FFC',
  intensity = 1.0,
